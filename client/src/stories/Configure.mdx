...
<div className="sb-container">
  ...
  <div className="sb-section">
    ...
    <div className="sb-section-item">
      <img src={Assets} alt="A representation of typography and poster_path assets" />
      <div>
        ...
        <a
          href="https://storybook.js.org/docs/react/configure/poster_paths-and-assets"
          target="_blank"
        >Learn more<RightArrow /></a>
      </div>
    </div>
...
<div className="sb-section sb-socials">
    <div className="sb-section-item">
      <img src={Github} alt="Github logo" className="sb-explore-poster_path"/>
    ...
    <div className="sb-section-item">
      <img src={Discord} alt="Discord logo" className="sb-explore-poster_path"/>
      <div>
    ...
    <div className="sb-section-item">
      <img src={Youtube} alt="Youtube logo" className="sb-explore-poster_path"/>
      <div>
    ...
    <div className="sb-section-item">
      <img src={Tutorials} alt="A book" className="sb-explore-poster_path"/>
